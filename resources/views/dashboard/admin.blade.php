...
@section('content')
    <div class="form-head d-flex align-items-center mb-sm-4 mb-3">
        <div class="mr-auto">
            ...
            <p class="mb-0">{{config('app.name')}} Admin Dashboard</p>
        </div>
    </div>
    <div class="row">
                    ...
                    <a href="{{route('rekam')}}" class="media align-items-center">
                        <div class="media-body mr-3">
                            <h2 class="fs-34 text-black font-w600">
                                {{$query->checkUpThisDay()}}
                            </h2>
                            <div>Periksa hari ini</div>
                            <div>({{date('d M Y')}})</div>
                        </div>
...
{{--                </div>--}}
        ...
        <div class="col-xl-3  col-sm-6">
            <div class="card rounded">
                <div class="card-body">
                    <a href="{{route('pasien')}}"  class="media align-items-center">
                        <div class="media-body mr-3">
                            <h2 class="fs-34 text-black font-w600">
                                {{$query->totalPasien()}}
                            </h2>
        ...
        <div class="col-xl-3  col-sm-6">
            <div class="card rounded">
                <div class="card-body">
                    <a href="{{route('dokter')}}" class="media align-items-center">
                        <div class="media-body mr-3">
                            <h2 class="fs-34 text-black font-w600">
                                {{$query->totalDoktor()}}
                            </h2>
        ...
        <div class="col-md-6">
            <div class="card rounded appointment-schedule">
                <div class="card-header pb-0 border-0">
                    <h3 class="fs-20 text-black mb-0">Perawatan {{$treatment['label']}}</h3>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            @if ($rekam_by_date->count())
                                @foreach ($rekam_by_date as $item)
                                <div class="d-flex pb-3 border-bottom mb-3 align-items-center">
                                    ...
                                    <a href="{{Route('rekam.detail', ['id' => $item->id, 'section' => 'general'])}}"
                                       class="text-success mr-3 mb-2">
                                        <i class="las la-chevron-circle-right scale5"></i>
                                    </a>
                                </div>
                                @endforeach
                            @else

                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <select name="tipe_pasien" id="tipe_pasien" required class="form-control">
                                    <option value="Umum/Mandiri" {{$data->tipe_pasien=="Umum/Mandiri" ? 'selected' : ''}}>Umum/Mandiri</option>
                                    <option value="Jaminan Kesehatan" {{$data->tipe_pasien=="Jaminan Kesehatan" ? 'selected' : ''}}>Jaminan Kesehatan</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
...
{{--                        </div>--}}
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select name="poli" id="poli" class="form-control" required>
                                    @foreach ($poli as $item)
                                        @if ($data->poli && $data->poli->nama == $item->nama)
                            ...
                            <div class="col-sm-4">
                                <select name="dokter_id" id="dokter_id" class="form-control"></select>
                                @error('dokter_id')
                                <div class="invalid-feedback animated fadeInUp"
                                style="display: block;">{{$message}}</div>
                                @enderror
        ...
        $.get(
            ...
            function(data) {
                ...
                $.each(data.data, function(index, value) {
                    string = string + `<option value="` + value.id + `" ` +
                        (value.id === {{$data->dokter_id}} ? `selected` : ``) + `>` + value.nama + `</option>`;
                })
